...
namespace IMS.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required(ErrorMessage = RequiredMessage)]
            [StringLength(100, ErrorMessage = "Паролата трябва да бъде поне {2} символа дълга и да не надвишава {1} симовла.", MinimumLength = 6)]
            ...
            [StringLength(MaxNameLength, ErrorMessage = NameErrorMessage,
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user,
                        ...
                        .Claim(UserFullNameClaim, $"{user.FirstName} {user.LastName}"));
